...
HD_PWD='F:/Hardware_Eng/Lab07/Lab07.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Two_Digit_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Two_Digit_Counter.tcl
