...
HD_PWD='F:/Hardware_Eng/Lab07/Lab07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Two_Digit_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Two_Digit_Counter.tcl -notrace
